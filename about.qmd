...
# Buat plot diagram lingkaran
plot <- ggplot(data, aes(x = "", y = Nilai, fill = Kategori)) +
  geom_bar(stat = "identity", width = 1, color = "white") +
  coord_polar("y", start = 0) +
  labs(title = "Diagram Lingkaran", fill = "Kategori")

# Simpan plot ke dalam file gambar (misalnya PNG)
ggsave("diagram_lingkaran.png", plot, width = 5, height = 5, units = "in")

# Sisipkan file gambar ke dalam dokumen QMD
# [insert-image]('path/ke/diagram_lingkaran.png')